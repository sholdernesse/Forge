...
Sprint 4.16 upgrades training export to a styled, two-sheet Excel report with summary KPIs, frozen headers, filters, typed cells, and meaningful discomfort highlighting while retaining CSV.
