...
**Current checkpoint:** Sprint 4.60 on PR #2
...
- ~~Camera barcode capture with manual fallback.~~ Native secure-camera scanning delivered in Sprint 4.55; Sprint 4.57 makes HTTPS and camera capability failures explicit, Sprint 4.58 provides trusted local HTTPS, Sprint 4.59 adds an iPhone-compatible decoder, and Sprint 4.60 connects that local scanner to the food-data API through the same secure origin.
